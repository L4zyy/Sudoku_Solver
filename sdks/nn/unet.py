...
class UNet(nn.Module):
    def __init__(self, inShape):
        ...
        # 512
        self.down1 = EncoderBlock(channels, 32) #256
        self.down2 = EncoderBlock(32, 64) #128
        self.down3 = EncoderBlock(64, 128) #64
        self.down4 = EncoderBlock(128, 256) #32
        ...
        #32
        self.up4 = DecoderBlock(256, 256, 128) #64
        self.up3 = DecoderBlock(128, 128, 64) #128
        self.up2 = DecoderBlock(64, 64, 32) #256
        self.up1 = DecoderBlock(32, 32, 32) #512

        self.classify = nn.Conv2d(32, 1, kernel_size=1, bias=True)
...
if __name__ == "__main__":
    ...
    model = UNet((3, 512, 512)).to(device)
